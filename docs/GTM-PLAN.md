...
_Created 2026-07-18. Strategy of record for launching + marketing the capx-cafe MCP server.
Execution is GATED on the build/publish decisions (npm publish, license, repo-public) being made first._
