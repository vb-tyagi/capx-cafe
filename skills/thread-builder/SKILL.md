---
name: thread-builder
description: Turn raw material into a numbered X thread — a sharp hook, one idea per post, a clean close/CTA. You draft it; capx ships each post in order, guarded.
argument-hint: "the raw material — notes, a story, a decision log, or a topic + the key points"
version: 0.1.0
tools: [post_now, create_loop, list_loops, whoami]
---
