---
name: draft-review
description: Dry-run a draft through the casserole guardrail WITHOUT posting — see whether it would pass, be held, or be blocked, and why, so you can fix it before it ships. You draft; capx just lints.
argument-hint: "[optional: the draft text, or 'check the last one you wrote']"
version: 0.1.0
tools: [preview, post_now, create_loop]
---
