---
description: "Turn a merged PR or GitHub release into a clear \"we shipped X, here's what it means for you\" X post or short thread. You draft from the real diff/notes; capx ships it guarded."
argument-hint: "[optional: a PR number/URL, a release tag, or 'the last merge' — plus 'post now' or a schedule like 'weekdays 9am']"
---
