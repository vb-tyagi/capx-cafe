---
description: "Turn a bug you just fixed — the session's debugging or a closed issue — into one specific 'we fixed X' post. You draft from the real diff; capx never writes, it ships it guarded."
argument-hint: "[optional: an issue/PR/commit, or which bug — defaults to the fix you just did]"
---
